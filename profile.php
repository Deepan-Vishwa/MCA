...
$query = "select *,DATE_ADD(paymet_info.date, INTERVAL 3 MONTH) AS due from client inner join paymet_info on client.id = paymet_info.client_id WHERE client.id =".$_SESSION["clientid"];
